...
urlpatterns = [
        ...
        path(
            "opinions/<int:opinion_id>/",
            views.opinion_detail,
            name="opinion_detail"
        ),
        ...
        path(
            "opinions/<int:opinion_id>/comment/",
            views.opinion_comment,
        ...
        path(
            "lesson/question/",
            views.post_lesson_question,
            name="post_lesson_question"
        ),

        path(
            "lesson/questions/",
            views.lesson_question_list,
            name="lesson_question_list"
        ),
        ...
        path(
            "teacher/opinions/",
            views.opinion_admin_list,
            name="opinion_admin_list"
        ),
